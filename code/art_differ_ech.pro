pro art_differ_ech,probe=probe
  window,xs=1600,ys=1000
  !p.charsize=1.0

;  array = con_text()
  
  array = ['2021-05-26/10:00','2021- 11-18/20:00']
  for ii=1.,N_ELEMENTS(array)-1 do begin
    ...
    ylim,'*_peef_eflux_energy_pa_*',1,5e4,1
    zlim,'*_peef_eflux_energy_pa_*',1e4,1e8,1
    
    ylim,'*_fce',1e0,8e3,1
    zlim,'th'+probe[0]+'_fff_*_e*',1e-14,1e-8,1
    
    options,'*_peef_eflux_energy_pa_0-20',$
      ytitle='energy_pa_0-20',$
      ztitle='[eV]'
    options,'*_peef_eflux_energy_pa_70-110',$
      ytitle='energy_pa_70-110',$
      ztitle='[eV]'
    options,'*_peef_eflux_energy_pa_160-180',$
      ytitle='energy_pa_160-180',$
      ztitle='[eV]'
    ...
    tplot,['th'+probe[0]+'_peef_eflux_energy_pa_0-20','th'+probe[0]+'_peef_eflux_energy_pa_70-110','th'+probe[0]+'_peef_eflux_energy_pa_160-180',$ ;pitch angle
      'th'+probe[0]+'_fff_64_eac34_fce',$
      'th'+probe[0]+'_Bcon_flg',$
