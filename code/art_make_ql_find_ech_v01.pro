...
;関数の呼び出し設定
pro art_make_ql_find_ech_v01,probe=probe,start=start,days=days
...
for ii=0.,days-1 do begin
	...
	thm_load_esa,probe=probe,datatype='pe?f_en_eflux peef_sc_pot',level='l2'
...
;		data=['th'+probe+'_fff_64_scm1','th'+probe+'_fgs_fce']
	...
	for jj=0.,loop_in_day-1 do begin
		...
		tplot,['th'+probe+'_peif_en_eflux','th'+probe+'_peef_en_eflux_pot',$
				 'th'+probe+'_fff_*_e*_fce','th'+probe+'_fff_*_s*_fce',$
